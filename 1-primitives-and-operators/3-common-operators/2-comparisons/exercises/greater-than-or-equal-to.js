...
const _3_actual = undefined >= false;
...
console.log(_5_actual === _5_expect, 'Test 5');

const _6_expect = true; // __
const _6_actual = '13' >= true;
console.assert(_6_actual === _6_expect, 'Test 6');
console.log(_6_actual === _6_expect, 'Test 6');

const _7_expect = false; // __
const _7_actual = 'aa' >= 'ab';
console.assert(_7_actual === _7_expect, 'Test 7');
console.log(_7_actual === _7_expect, 'Test 7');

const _8_expect = true; // __
const _8_actual = 'aa' >= 'aa';
console.assert(_8_actual === _8_expect, 'Test 8');
console.log(_8_actual === _8_expect, 'Test 8');

const _9_expect = true; // __
const _9_actual = 0 >= '';
console.assert(_9_actual === _9_expect, 'Test 9');
console.log(_9_actual === _9_expect, 'Test 9');
