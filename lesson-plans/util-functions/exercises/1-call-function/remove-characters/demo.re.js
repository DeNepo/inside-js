...
}
{
	const STRING_INPUTS = [
		...
		displayString = (_0x21148e = NO_ARG, _0x21e84d = NO_ARG) => {
		...
		removeConsonants = () => {
			...
			displayString(_0x37e796(0x1cc), _0x51a878);
		};
	...
	const removeThese = () => {
		...
		displayString(_0x32ab13(0x1cc), _0x4f4dea);
	};
	...
	const removeVowels = () => {
		...
		displayString('secret-solution', _0x5f3946);
	};
