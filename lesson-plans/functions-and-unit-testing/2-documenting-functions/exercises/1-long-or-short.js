...
/**
 * Check if the text shorter thab cutoff
 *
 * @param{string} text  - should be check for length
 * @param {number} cutoff - number of length
 * @return {string} if text shorter than cutoff return short, else cutoff return - long
 */
